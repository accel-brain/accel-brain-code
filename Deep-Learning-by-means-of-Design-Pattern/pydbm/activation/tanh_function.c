...
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5pydbm_10activation_13tanh_function_DOUBLE_t = { "DOUBLE_t", NULL, sizeof(__pyx_t_5pydbm_10activation_13tanh_function_DOUBLE_t), { 0 }, 0, 'R', 0, 0 };
...
static PyObject *__pyx_pf_5pydbm_10activation_13tanh_function_12TanhFunction_activate(CYTHON_UNUSED PyObject *__pyx_self, CYTHON_UNUSED PyObject *__pyx_v_self, PyArrayObject *__pyx_v_x) {
  ...
  __pyx_pybuffernd_x.rcbuffer = &__pyx_pybuffer_x;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_x.rcbuffer->pybuffer, (PyObject*)__pyx_v_x, &__Pyx_TypeInfo_nn___pyx_t_5pydbm_10activation_13tanh_function_DOUBLE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 13, __pyx_L1_error)
  }
  __pyx_pybuffernd_x.diminfo[0].strides = __pyx_pybuffernd_x.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_x.diminfo[0].shape = __pyx_pybuffernd_x.rcbuffer->pybuffer.shape[0];

  /* "pydbm/activation/tanh_function.pyx":24
 *         '''
 *         cdef double x_sum
 *         x_sum = x.sum()             # <<<<<<<<<<<<<<
 *         if x_sum != 0:
 ...
 */
  ...
  if (__pyx_t_5) {
    ...
    /* "pydbm/activation/tanh_function.pyx":26
 *         x_sum = x.sum()
 *         if x_sum != 0:
 *             x = x / x_sum             # <<<<<<<<<<<<<<
 *         return np.tanh(x)
 */
    __pyx_t_1 = PyFloat_FromDouble(__pyx_v_x_sum); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 26, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_2 = __Pyx_PyNumber_Divide(((PyObject *)__pyx_v_x), __pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 26, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    ...
    __pyx_t_6 = ((PyArrayObject *)__pyx_t_2);
    {
      ...
      __pyx_t_7 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_x.rcbuffer->pybuffer, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_5pydbm_10activation_13tanh_function_DOUBLE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack);
      if (unlikely(__pyx_t_7 < 0)) {
        PyErr_Fetch(&__pyx_t_8, &__pyx_t_9, &__pyx_t_10);
        if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_x.rcbuffer->pybuffer, (PyObject*)__pyx_v_x, &__Pyx_TypeInfo_nn___pyx_t_5pydbm_10activation_13tanh_function_DOUBLE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
 ...
 */
  ...
  /* "pydbm/activation/tanh_function.pyx":27
 *         if x_sum != 0:
 *             x = x / x_sum
 *         return np.tanh(x)             # <<<<<<<<<<<<<<
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_tanh); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 27, __pyx_L1_error)
  ...
  if (!__pyx_t_1) {
    __pyx_t_2 = __Pyx_PyObject_CallOneArg(__pyx_t_3, ((PyObject *)__pyx_v_x)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 27, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
  } else {
    #if CYTHON_FAST_PYCALL
 ...
 *         Return the result from this activation function.
 */
  __pyx_tuple__10 = PyTuple_Pack(3, __pyx_n_s_self, __pyx_n_s_x, __pyx_n_s_x_sum); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 13, __pyx_L1_error)
