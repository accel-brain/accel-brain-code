...
class RBMAnnealing(metaclass=ABCMeta):
    ...
    def __init__(
        ...
        while `start`, `end`, and `velocity` is generated by variations of input MIDI data,  
        where the variations is formed by drawing random samples from a Gaussian distribution.
