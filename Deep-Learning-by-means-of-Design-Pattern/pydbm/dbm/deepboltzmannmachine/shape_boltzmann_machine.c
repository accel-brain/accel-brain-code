...
static PyObject *__pyx_pf_5pydbm_3dbm_20deepboltzmannmachine_23shape_boltzmann_machine_21ShapeBoltzmannMachine_10__reshape_inferenced_data(CYTHON_UNUSED PyObject *__pyx_self, CYTHON_UNUSED PyObject *__pyx_v_self, PyArrayObject *__pyx_v_observed_data_arr, PyArrayObject *__pyx_v_inferenced_data_arr) {
  ...
  Py_ssize_t __pyx_t_13;
  int __pyx_t_14;
  __pyx_t_5pydbm_3dbm_20deepboltzmannmachine_23shape_boltzmann_machine_DOUBLE_t __pyx_t_15;
 ...
 */
      ...
      __pyx_t_14 = -1;
      if (__pyx_t_12 < 0) {
        __pyx_t_12 += __pyx_pybuffernd_reshape_arr.diminfo[0].shape;
        if (unlikely(__pyx_t_12 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_12 >= __pyx_pybuffernd_reshape_arr.diminfo[0].shape)) __pyx_t_14 = 0;
      if (__pyx_t_13 < 0) {
        __pyx_t_13 += __pyx_pybuffernd_reshape_arr.diminfo[1].shape;
      ...
      __pyx_t_14 = -1;
      if (__pyx_t_16 < 0) {
        __pyx_t_16 += __pyx_pybuffernd_reshape_arr.diminfo[0].shape;
        if (unlikely(__pyx_t_16 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_16 >= __pyx_pybuffernd_reshape_arr.diminfo[0].shape)) __pyx_t_14 = 0;
      if (__pyx_t_17 < 0) {
        __pyx_t_17 += __pyx_pybuffernd_reshape_arr.diminfo[1].shape;
