...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "pydbm.clustering.computableclusteringloss.balanced_assignments_loss",
        "sources": [
            "./pydbm/clustering/computableclusteringloss/balanced_assignments_loss.pyx"
        ]
    },
    "module_name": "pydbm.clustering.computableclusteringloss.balanced_assignments_loss"
}
END: Cython Metadata */
...
/* Module declarations from 'pydbm.clustering.computableclusteringloss.balanced_assignments_loss' */
...
#define __Pyx_MODULE_NAME "pydbm.clustering.computableclusteringloss.balanced_assignments_loss"
...
/* Implementation of 'pydbm.clustering.computableclusteringloss.balanced_assignments_loss' */
...
static PyObject *__pyx_pw_5pydbm_10clustering_24computableclusteringloss_25balanced_assignments_loss_23BalancedAssignmentsLoss_1__init__(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("pydbm.clustering.computableclusteringloss.balanced_assignments_loss.BalancedAssignmentsLoss.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
...
static PyObject *__pyx_pw_5pydbm_10clustering_24computableclusteringloss_25balanced_assignments_loss_23BalancedAssignmentsLoss_3compute_clustering_loss(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("pydbm.clustering.computableclusteringloss.balanced_assignments_loss.BalancedAssignmentsLoss.compute_clustering_loss", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
...
if (!__Pyx_RefNanny) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "pydbm.clustering.computableclusteringloss.balanced_assignments_loss")) {
      if (unlikely(PyDict_SetItemString(modules, "pydbm.clustering.computableclusteringloss.balanced_assignments_loss", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pydbm.clustering.computableclusteringloss.balanced_assignments_loss", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pydbm.clustering.computableclusteringloss.balanced_assignments_loss");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
